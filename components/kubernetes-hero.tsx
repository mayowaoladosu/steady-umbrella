...
import { ArrowRight, Hexagon, Layers, Activity, Shield } from "lucide-react"
import Link from "next/link"

const ease = [0.22, 1, 0.36, 1] as const

export function KubernetesHero() {
    return (
        <section className="relative w-full px-6 pt-20 pb-12 lg:px-12 lg:pt-32 lg:pb-20 overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div className="flex flex-col gap-6">
                    ...
                    >
                        <Hexagon size={14} className="text-[#ea580c]" />
                    ...
                    >
                        Deploy production-ready Kubernetes clusters in seconds. Nubis Managed Kubernetes
                        takes care of the control plane, security patching, and upgrades so you can
                    ...
                    >
                        <Link href="https://console.usenubis.com/kubernetes/create">
                            <motion.button
                            ...
                            >
                                ...
                                <span className="px-6 py-2.5">Provision Cluster</span>
                            </motion.button>
                        </Link>
                    </motion.div>
                </div>
                ...
                >
                    ...
                    <Image
                        ...
                        alt="Managed Kubernetes Illustration"
                        fill
            ...
            <div className="mt-20 grid grid-cols-2 md:grid-cols-4 border-2 border-foreground divide-x-2 divide-y-2 md:divide-y-0 divide-foreground">
                {[
                    { icon: Layers, label: "Management", value: "Fully Managed CP" },
                    { icon: Shield, label: "Security", value: "RBAC & Isolated Nodes" },
                    { icon: Activity, label: "Reliability", value: "Self-Healing Clusters" },
                    { icon: Hexagon, label: "Scaling", value: "Auto-Scale Worker Nodes" }
                ].map((feat, i) => (
                    <motion.div
                        key={feat.label}
