...
import { ArrowRight, Database, Shield, Zap, RefreshCw } from "lucide-react"
        ...
        <section className="relative w-full px-6 pt-20 pb-12 lg:px-12 lg:pt-32 lg:pb-20 overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div className="flex flex-col gap-6">
                    ...
                    >
                        <Database size={14} className="text-[#ea580c]" />
                    ...
                    >
                        Deploy high-performance database clusters in seconds. Nubis Managed Databases
                        handles backups, patching, and high availability so you can focus on your data
                    ...
                    >
                        <Link href="https://console.usenubis.com/databases/create">
                            <motion.button
                            ...
                            >
                                ...
                                <span className="px-6 py-2.5">Launch Database</span>
                            </motion.button>
                        </Link>
                    </motion.div>
                </div>
                ...
                >
                    ...
                    <Image
                        src="/images/databases-hero.png"
                        alt="Managed Databases Illustration"
                        fill
            ...
            <div className="mt-20 grid grid-cols-2 md:grid-cols-4 border-2 border-foreground divide-x-2 divide-y-2 md:divide-y-0 divide-foreground">
                {[
                    { icon: Shield, label: "Security", value: "Encrypted at Rest" },
                    { icon: Zap, label: "Performance", value: "Sub-ms Latency" },
                    { icon: RefreshCw, label: "Availability", value: "99.99% Uptime SLA" },
                    { icon: Database, label: "Maintenance", value: "Zero-Downtime Patch" }
                ].map((feat, i) => (
                    <motion.div
                        key={feat.label}
